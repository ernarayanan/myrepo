...
public class MySelenium  implements Selenium{
	...
	public MySelenium(String browser){
	...
	public void type(WebElement element, String textToSearch) {
		Actions actions = moveTo(element);
	...
	public Actions moveTo(WebElement toolTip) {
		Actions actions = new Actions(driver);
		actions.moveToElement(toolTip).click(toolTip).perform();
		return actions;
	}
	...
	public void typeUserName(WebElement element, String username) {
		element.sendKeys(username);
		
	}

	public void typePassword(WebElement passwd, String password) {
